...
class RegionTableViewController: UITableViewController {
    ...
    override func tableView(_ tableView: UITableView, numberOfRowsInSection section: Int) -> Int {
        ...
        return AppConstants.txtArray.count
    }
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        cell.titleLabel.text = AppConstants.txtArray[indexPath.row].replacingOccurrences(of: ".txt", with: "")
        
        return cell
    }
 
    override func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        self.parent?.performSegue(withIdentifier: MainStoryBoardConstants.showWeather, sender:  AppConstants.txtArray[indexPath.row].replacingOccurrences(of: ".txt", with: ""))
    }
    /*
